          ...
          <CardContent className="pt-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <div className="flex-1 space-y-4 w-full">
                ...
                <div className="flex items-center gap-3 p-4 rounded-lg bg-gradient-to-r from-accent/10 to-transparent border border-accent/20">
                  <MapPin className="h-5 w-5 text-accent flex-shrink-0" />
                  <div>
                    <p className="text-sm font-semibold text-muted-foreground">Pontos de Fidelidade</p>
                    <p className="text-2xl font-bold text-accent">{profile?.loyalty_points || 0} pontos</p>
                  </div>
                </div>
              </div>
            </div>
