-- Inserir templates padrão de notificações automáticas se não existirem
INSERT INTO notification_templates (title, message, type, is_system, description, icon)
VALUES 
  ('Agendamento Confirmado', 'Olá {customer_name}! Seu agendamento com {barber_name} para {service_name} foi confirmado para {appointment_date} às {appointment_time}. Te esperamos!', 'confirmation', true, 'Enviado automaticamente quando um agendamento é confirmado', 'CheckCircle'),
  ('Agendamento Cancelado', 'Olá {customer_name}! Seu agendamento com {barber_name} para {service_name} do dia {appointment_date} às {appointment_time} foi cancelado.', 'cancellation', true, 'Enviado automaticamente quando um agendamento é cancelado', 'XCircle'),
  ('Agendamento Reagendado', 'Olá {customer_name}! Seu agendamento com {barber_name} para {service_name} foi reagendado para {appointment_date} às {appointment_time}. Te esperamos!', 'update', true, 'Enviado automaticamente quando um agendamento é reagendado', 'Calendar'),
  ('Obrigado pela Visita!', 'Olá {customer_name}! Agradecemos sua visita com {barber_name}. Esperamos vê-lo novamente em breve! Se tiver algum feedback, ficaremos felizes em ouvir.', 'system', true, 'Enviado automaticamente após conclusão do agendamento', 'Heart'),
  ('Lembrete de Agendamento', 'Olá {customer_name}! Lembrete: Seu agendamento com {barber_name} para {service_name} é em {hours_text} ({appointment_time}). Te esperamos!', 'reminder', true, 'Enviado automaticamente horas antes do agendamento', 'Bell')
...
-- Atualizar trigger de confirmação para usar templates
...
-- Atualizar trigger de cancelamento para usar templates
...
-- Atualizar trigger de reagendamento para usar templates
...
-- Atualizar trigger de agradecimento para usar templates
